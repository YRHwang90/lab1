...
group_by() <-grouping dataset as assigned column 
ungroup()<- function cancels that grouping 

summarize() <- This is often used with group_by(
This function can print the output according to the 
group_by().

facet_grid(y~x,...)<- variable y as a row, variable x as a column  
facet_wrap(x,... )<-when the variable is only one
